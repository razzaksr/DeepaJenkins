package basics.deepa.spring.DeepaSpringBoot.security;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.inMemoryAuthentication().withUser("deepa").password("deepaforum").roles("ADMIN");
		auth.inMemoryAuthentication().withUser("razak").password("deepaforum").roles("ADMIN");
	}
	@Override
